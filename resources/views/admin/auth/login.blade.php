...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form class="form-horizontl" role="form" method="POST" action="{{ url('admin/login') }}">
            {{ csrf_field() }}
        ...
        <div class="social-auth-links text-center">
            <p>- OR -</p>
            <a href="{{ url('admin/register') }}" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-user-plus"></i> Register a new membership</a>
            <a href="{{ url('admin/password/reset') }}" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-key"></i>I forgot my password</a>
        </div>
