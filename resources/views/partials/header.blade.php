<a href="offer.html"><img src="{{URL::asset('img/images/download.png')}}" class="img-head" alt=""></a>
<div class="header">

    <div class="container">

        <div class="logo">
            <h1 ><a href="{{ route('product.index') }}">Peculiar Grace<span>The Best Supermarket</span></a></h1>
        </div>
        <div class="head-t">
            <ul class="card">
        ...
        <div class="nav-top">
            <nav class="navbar navbar-default">
                ...
                <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                    <ul class="nav navbar-nav ">
                            ...
                            <ul class="dropdown-menu multi">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 w3l">
                                        <a href="kitchen.html"><img src="{{URL::asset('img/images/me.png')}}" class="img-responsive" alt=""></a>
                                    </div>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu multi multi1">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 w3l">
                                        <a href="care.html"><img src="{{URL::asset('img/images/me1.png')}}" class="img-responsive" alt=""></a>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </ul>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu multi multi2">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 w3l">
                                        <a href="hold.html"><img src="{{URL::asset('img/images/me2.png')}}" class="img-responsive" alt=""></a>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </ul>
                        ...
                        <li><a href="codes.html" class="hyper"> <span>Gallery</span></a></li>
            ...
            <div class="cart" >
                ...
                <span class="fa fa-shopping-cart my-cart-icon"><span class="badge badge-notify my-cart-badge">{{ Session::has('cart') ? Session::get('cart')->totalQty : '' }}</span></span>
                </a>
            </div>
            <div class="clearfix"></div>
        </div>
