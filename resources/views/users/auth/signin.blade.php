...
<div class="login-box">
    ...
    <div class="social-auth-links text-center">
        <p>- OR -</p>
        <a href="{{ url('/signup') }}" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-user-plus"></i> Register a new membership</a>
        <a href="{{ url('/reset') }}" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-key"></i>I forgot my password</a>
    </div>
